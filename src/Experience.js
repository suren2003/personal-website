  ...
  const experienceData = [
    {
      ...
      brief:
        "This role was a very big and interesting change for myself. I went from working on test automation on web development to embedded programming and wireless communications. My focus was put on developing an internal tool, baseband software, and an testing framework to emulate hardware testing.",
      tech: "C/C++, Python, YAML, 5G NR, Agile, Git",
      resume: (
        <ul>
          <li>
            Developed features to enable sub-argument-driven configuration
            selection, simplify configuration process, and sup- port to generate
            multiple testcases for a Python tool that does automated YAML test
            case generations
          </li>
          <li>
    ...
    },
    {
      ...
      brief:
        "This is my second term in this position with Nokia. Because of my previous term, I built up trust and was given more responsibilities. This included the migration of multiple test suites into the newly React based web app and verification of bug fixes by devs.",
      ...
      resume: (
        <ul>
          ...
          <li>
            ...
            thorough manual testing across various scenarios and environments
          </li>
        </ul>
      ),
    },
    {
      ...
      brief:
        "This was my first internship position where I gained lots of great professional experience. I mainly focused on finding and fixing issues from regression test reports.",
      tech: "JavaScript, Node.js, MochaJS, YAML, Postman, OpenStack, Agile, Git",
      resume: (
        <ul>
          <li>
          ...
          <li>
            ...
            defects identified in regression tests by utilizing debugging
            techniques and core web principals on the test automation code and
            web app
          </li>
        </ul>
      ),
      ...
      <div className="experience-container">
        {experienceData.map((experience, index) => (
          ...
          >
            ...
            <p>
              <b>{experience.company}</b>, {experience.dates}
            </p>
          </div>
        ))}
      </div>
      ...
      {selectedBox && (
        <div className="modal-overlay" onClick={() => setSelectedBox(null)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <p>
              <b>{selectedBox.company}</b>, {selectedBox.dates}
            </p>
            <p className="brief">{selectedBox.brief}</p>
            <p className="tech">
